...
\end{lstlisting}
			...
			\begin{wrapfigure}{r}{0.5\textwidth}
				\includegraphics[keepaspectratio = true, width = 0.5\textwidth]{screenshot5}
...
\end{lstlisting}
			...
			\begin{wrapfigure}{r}{0.5\textwidth}
				\includegraphics[keepaspectratio = true, width = 0.5\textwidth]{screenshot6}
		...
		\subsubsection{Iteration 5}
			...
			\begin{wrapfigure}{r}{0.5\textwidth}
				\includegraphics[keepaspectratio = true, width = 0.5\textwidth]{screenshot7}
		 ...
		 \subsubsection{Iteration 6}
			...
			\begin{wrapfigure}{r}{0.5\textwidth}
				\includegraphics[keepaspectratio = true, width = 0.5\textwidth]{screenshot8}
...
\end{lstlisting}
			...
			\begin{figure}[h]
				\begin{center}
					\includegraphics[keepaspectratio = true, scale = 0.5]{figure1}
